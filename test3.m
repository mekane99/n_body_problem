...
%time = 7.92438e09; %how long to run simulation
time = 6.935e7;
h = 10000; %time step
...
r_BIG2keep = zeros(3,time/h);
r_BIG3keep = zeros(3,time/h);
r_BIG4keep = zeros(3,time/h);
r_BIG5keep = zeros(3,time/h);
r_BIG6keep = zeros(3,time/h);
r_BIG7keep = zeros(3,time/h);
r_BIG8keep = zeros(3,time/h);
r_BIG9keep = zeros(3,time/h);
r_BIG10keep = zeros(3,time/h);
...
r_SMALL2keep = zeros(3,time/h);
r_SMALL3keep = zeros(3,time/h);
r_SMALL4keep = zeros(3,time/h);
r_SMALL5keep = zeros(3,time/h);
r_SMALL6keep = zeros(3,time/h);
r_SMALL7keep = zeros(3,time/h);
r_SMALL8keep = zeros(3,time/h);
r_SMALL9keep = zeros(3,time/h);
r_SMALL10keep = zeros(3,time/h);
...
hold on 
plot3(r_BIG4keep(1,:),r_BIG4keep(2,:),r_BIG4keep(3,:),'LineWidth',1)
hold on 
plot3(r_BIG5keep(1,:),r_BIG5keep(2,:),r_BIG5keep(3,:),'LineWidth',1)
hold on 
plot3(r_SMALL4keep(1,:),r_SMALL4keep(2,:),r_SMALL4keep(3,:),'LineWidth',1)
hold on 
plot3(r_SMALL5keep(1,:),r_SMALL5keep(2,:),r_SMALL5keep(3,:),'LineWidth',1)
grid on
legend('Sun','Normal Earth','Normal Mars','Earth w/ Betelgeuse','Mars w/ Betelgeuse','Earth w/ Proxima Centuri','Mars w/ Proxima Centuri')
title('Earth and Mars with different mass Sun','Fontsize',20)
...
plot3(r_5keep(1,:),r_5keep(2,:),r_5keep(3,:),'LineWidth',1)
hold on
plot3(r_SMALL2keep(1,:),r_SMALL2keep(2,:),r_SMALL2keep(3,:),'LineWidth',1)
hold on
plot3(r_SMALL3keep(1,:),r_SMALL3keep(2,:),r_SMALL3keep(3,:),'LineWidth',1)
hold on
plot3(r_SMALL4keep(1,:),r_SMALL4keep(2,:),r_SMALL4keep(3,:),'LineWidth',1)
hold on 
plot3(r_SMALL5keep(1,:),r_SMALL5keep(2,:),r_SMALL5keep(3,:),'LineWidth',1)
grid on
legend('Sun','Mercury','Venus','Earth','Mars','Mercury w/ Proxima Centuri','Venus w/ Proxima Centuri','Earth w/ Proxima Centuri','Mars w/ Proxima Centuri')
title('Inner Planets with Proxima Centuri as Sun VS. Normal Orbits','Fontsize',20)
xlabel('Meters','Fontsize',16)
ylabel('Meters','Fontsize',16)
zlabel('Meters','Fontsize',16)
set(gcf, 'PaperPositionMode', 'manual')
...
plot3(r_5keep(1,:),r_5keep(2,:),r_5keep(3,:),'LineWidth',1)
hold on
plot3(r_BIG3keep(1,:),r_BIG3keep(2,:),r_BIG3keep(3,:),'LineWidth',1)
hold on
plot3(r_BIG4keep(1,:),r_BIG4keep(2,:),r_BIG4keep(3,:),'LineWidth',1)
hold on 
grid on
plot3(r_BIG5keep(1,:),r_BIG5keep(2,:),r_BIG5keep(3,:),'LineWidth',1)
legend('Sun','Venus','Earth','Mars','Venus w/ Betelgeuse','Earth w/ Betelgeuse','Mars w/ Betelgeuse')
title('Inner Planets with Betelgeuse as Sun VS. Normal Orbits','Fontsize',20)
xlabel('Meters','Fontsize',16)
ylabel('Meters','Fontsize',16)
zlabel('Meters','Fontsize',16)
set(gcf, 'PaperPositionMode', 'manual')
...
plot3(r_2keep(1,:),r_2keep(2,:),r_2keep(3,:),'LineWidth',1)
hold on
plot3(r_BIG2keep(1,:),r_BIG2keep(2,:),r_BIG2keep(3,:),'LineWidth',1)
grid on
legend('Sun','Mercury','Mercury w/ Betelgeuse')
title('Inner Planets with Betelgeuse as Sun VS. Normal Orbits','Fontsize',20)
xlabel('Meters','Fontsize',16)
ylabel('Meters','Fontsize',16)
zlabel('Meters','Fontsize',16)
